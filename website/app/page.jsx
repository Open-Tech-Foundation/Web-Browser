        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: "Open PDFs, CSV spreadsheets, JSON data, Markdown docs, and code files directly in the browser — all with syntax highlighting and interactive previews. Markdown files show source alongside a rendered preview, CSV files open as sortable tables, and everything from Python to C++ gets full-color syntax highlighting.",

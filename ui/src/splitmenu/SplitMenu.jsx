...
const send = (method, params = {}) => {
  nativeRequest({ method, params }).catch(() => {});
};
  ...
  return (
    <Popup name="splitmenu" title="Split View" className="p-3 shadow-[0_18px_55px_rgba(15,23,42,0.28)]" closeOnBlur>
      <div className="space-y-1">
        <MenuButton label="Exit split view" onClick={() => send('split.close')}>
          <path d="M5 12h14" />
        </MenuButton>
        <MenuButton label="Swap panes" onClick={() => send('split.swap')}>
          <path d="m7 7-3 3 3 3" />
          <path d="M4 10h10" />
        ...
        <MenuButton label="Close left pane" onClick={() => send('split.closePane', { pane: 'left' })}>
          <path d="M9 4v16" />
          <path d="M4 6h3" />
          <path d="M4 12h3" />
          <path d="M4 18h3" />
        ...
        <MenuButton label="Close right pane" onClick={() => send('split.closePane', { pane: 'right' })}>
          <path d="M15 4v16" />
          <path d="M17 6h3" />
          <path d="M17 12h3" />
          <path d="M17 18h3" />

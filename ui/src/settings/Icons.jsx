...
export const GoogleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" overflow="hidden" viewBox="0 0 268.152 273.883">
    <defs>
      ...
      <radialGradient xlinkHref="#google__o" id="google__o" cx="181.001" cy="177.201" r="71.46" fx="181.001" fy="177.201" gradientTransform="matrix(-.24858 2.08314 2.96249 .33417 -255.146 -331.164)" gradientUnits="userSpaceOnUse"/>
...
export const BingIcon = () => (
  <svg viewBox="0 0 24 24" fill="#00a4ef" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h11.5v11.5H0zM12.5 0H24v11.5H12.5zM0 12.5h11.5V24H0zM12.5 12.5H24V24H12.5z"/></svg>
);

export const YahooIcon = () => (
  <svg viewBox="0 0 24 24" fill="#6001d2" xmlns="http://www.w3.org/2000/svg"><path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zm3.3 18.5c1.4 0 2.5-1.1 2.5-2.5 0-1.2-.8-2.2-2-2.4V9.3h-2.6v4.3c-1.2.2-2 1.2-2 2.4 0 1.4 1.1 2.5 2.5 2.5 1 0 1.8-.6 2.3-1.4.5.8 1.3 1.4 2.3 1.4z"/></svg>
);

export const DuckDuckGoIcon = () => (
  <svg viewBox="0 0 24 24" fill="#de5833" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="12"/><path d="M12 4c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6z" fill="white"/></svg>
);

export const BaiduIcon = () => (
  <svg viewBox="0 0 24 24" fill="#212121" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></svg>
);

export const YandexIcon = () => (
  <svg viewBox="0 0 24 24" fill="#ff0000" xmlns="http://www.w3.org/2000/svg"><path d="M12.5 0H24l-8.5 24H4l8.5-24z"/></svg>
);

export const EcosiaIcon = () => (
  <svg viewBox="0 0 24 24" fill="#008a6c" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z"/></svg>
);

export const NaverIcon = () => (
  <svg viewBox="0 0 24 24" fill="#03cf5d" xmlns="http://www.w3.org/2000/svg"><path d="M16.27 12.87L14.7 7.2l-1.57 12.07L10.5 3 7.5 21h3l1.5-5.4 1.5 5.4h3l3-18z"/></svg>
);

export const StartpageIcon = () => (
  <svg viewBox="0 0 24 24" fill="#0159ac" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 18c4.41 0 8-3.59 8-8s-3.59-8-8-8-8 3.59-8 8 3.59 8 8 8zm-1-13h2v6h-2V7zm0 8h2v2h-2v-2z"/></svg>
);

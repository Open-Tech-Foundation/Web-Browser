    ...
    >
      ...
      {!tab.pinned && (
        <button
          ...
          title="Close tab"
          className={`ml-2 w-[18px] h-[18px] flex items-center justify-center rounded-full hover:bg-slate-300 dark:hover:bg-white/20 transition-all ${tab.active ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
        >
